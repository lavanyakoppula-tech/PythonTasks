...
# 📚 FastAPI + SQLite + Production-Level Design
# ============================================================
...
DATABASE_URL = "sqlite:///./real_library.db"
...
def add_librarian(
    ...
    try:
        ...
        existing_librarian = db.query(LibrarianDB).filter(
...
def return_book(
    ...
    try:
        ...
        issue_record = db.query(IssuedBookDB).filter(
...
def issued_books(
    ...
    books = db.query(IssuedBookDB).all()
